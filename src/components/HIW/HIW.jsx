              ...
              <div className='relative bg-gray-900/80 rounded-3xl p-8 shadow-2xl border border-gray-700/50 backdrop-blur-xl transform-style-preserve-3d'>
                ...
                <div className='relative z-20'>
                  ...
                  <p className='text-gray-300 font-lato text-lg leading-relaxed'>
                    {[
                      'Blockchain ensures tamper-proof records, eliminating fraud and increasing trust in real estate deals.',
                      'AI-driven analytics provide real-time property valuations and investment insights for better decision-making.',
                      'Tokenization allows fractional ownership, making real estate investment accessible and tradable worldwide.',
                    ][index]}
                  </p>
                </div>
